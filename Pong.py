...
def draw(canvas):
    ...
    # collide and reflect off of top and botton edges of canvas
    ...
    canvas.draw_text(str(score2), (WIDTH/4+WIDTH/2, 40), 24, 'White')  
...
reset_button = frame.add_button('Restart', reset_button_handler)
